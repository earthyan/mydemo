...
class PHPUnit_TextUI_Command
{
    ...
    protected function handleSelfUpdate($upgrade = false)
    {
        ...
        if (!$upgrade) {
            $remoteFilename = sprintf(
                'https://vendor.phpunit.de/phpunit-%s.vendor',
                file_get_contents(
                    sprintf(
                        'https://vendor.phpunit.de/latest-version-of/phpunit-%s',
        ...
        $tempFilename = tempnam(sys_get_temp_dir(), 'phpunit') . '.vendor';
        ...
        if (PHP_VERSION_ID < 50600) {
            $options['ssl']['CN_match']        = 'vendor.phpunit.de';
            $options['ssl']['SNI_server_name'] = 'vendor.phpunit.de';
        }
    ...
    protected function handleVersionCheck()
    {
        ...
        $latestVersion = file_get_contents('https://vendor.phpunit.de/latest-version-of/phpunit');
